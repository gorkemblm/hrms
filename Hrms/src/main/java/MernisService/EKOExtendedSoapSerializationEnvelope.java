...
public class EKOExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(EKODateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new EKOStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static EKODateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static EKODateTimeConverter dateTimeConverter = new EKOStandardDateTimeConverter();

    public EKOExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public EKOExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new EKOMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=EKOHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,EKOExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=EKOHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
