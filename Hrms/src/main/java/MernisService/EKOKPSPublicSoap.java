...
public class EKOKPSPublicSoap
{
    ...
    public EKOKPSPublicSoap(){}

    public EKOKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public EKOKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        EKOExtendedSoapSerializationEnvelope envelope= new EKOExtendedSoapSerializationEnvelope(EKOExtendedSoapSerializationEnvelope.VER11);
